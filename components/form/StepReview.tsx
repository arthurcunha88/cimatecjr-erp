...
export default function StepReview({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-[18px] sm:text-[19px] font-bold text-[#1a1c1c]">
          Confirme seus dados
        </h2>
      ...
      <div className="border border-[#e5e5e5] rounded-xl overflow-hidden w-full">
            ...
            <tbody>
              {rows.map(
                ([k, v], i) => (
                  ...
                  >
                    <td className="w-[32%] sm:w-32 px-3 py-3 sm:px-4 sm:py-2.5 text-[#888] align-top">
                      {k}
                    </td>

                    <td
                      className={`w-[68%] sm:w-auto px-3 py-3 sm:px-4 sm:py-2.5 text-[#1a1c1c] font-medium text-right align-top break-words ${
                        k === "E-mail"
                          ? "break-all"
                          : ""
                      }`}
      ...
      <div className="bg-[#f9f9f9] border border-[#e5e5e5] border-l-4 border-l-[#c8181e] rounded-lg p-3 sm:p-4">
        <p className="text-[11px] sm:text-[12px] text-[#5f5e5e] leading-relaxed">
        ...
        <label className="flex items-start gap-2 mt-3 cursor-pointer min-w-0">
          <input
            type="checkbox"
            checked={
              consentChecked
          ...
          <span className="min-w-0 text-[11px] sm:text-[12px] text-[#1a1c1c] leading-relaxed break-words">
